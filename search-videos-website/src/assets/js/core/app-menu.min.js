!(function(e, n, a) {
  ...
  (a.app.menu = {
      ...
      update: function() {
        if (this.obj) {
          if (!0 === a(".main-menu").data("scroll-to-active")) {
            var e;
            (e =
              a(".main-menu-content").find("li.active").parents("li").length > 0
                ? a(".main-menu-content")
                    .find("li.active")
                    .parents("li")
                    .last()
      ...
      if (a(".main-menu-content").length > 0) {
        ...
        if (
          ...
          "undefined" != typeof Storage &&
            (t = localStorage.getItem("menuLocked")), "false" === t
    ...
    change: function(e) {
        ...
        switch (n.name) {
          ...
          case "lg":
            "vertical-overlay-menu" === t
              ? this.hide()
              : "collapsed" === e ? this.collapse(e) : this.expand();
            break;
          case "md":
      ...
      ("vertical-menu" !== t && "vertical-menu-modern" !== t) ||
        this.toOverlayMenu(n.name), i.is(".horizontal-layout") &&
        !i.hasClass(".horizontal-menu-demo") &&
        (
          this.changeMenu(n.name),
          a(".menu-toggle").removeClass("is-active")
        ), "horizontal-menu" != t && this.drillDownMenu(n.name), "xl" ==
        n.name &&
        (
          ...
          a('body[data-open="hover"] .dropdown a').on("click", function(e) {
            if ("horizontal-menu" == t && a(this).hasClass("dropdown-toggle"))
              return !1;
          })
        ), a(".header-navbar").hasClass("navbar-brand-center") &&
        a(".header-navbar").attr("data-nav", "brand-center"), "sm" == n.name ||
      "xs" == n.name
        ...
        : a(".header-navbar[data-nav=brand-center]").addClass(
            "navbar-brand-center"
          ), a("ul.dropdown-menu [data-toggle=dropdown]").on("click", function(
        e
      ) {
        a(this).siblings("ul.dropdown-menu").length > 0 &&
          ...
          .parent()
          .siblings()
          .removeClass("show"), a(this).parent().toggleClass("show");
      }), "horizontal-menu" == t &&
        ("sm" == n.name || "xs" == n.name
          ? a(".menu-fixed").length && a(".menu-fixed").unstick()
          : a(".navbar-fixed").length &&
            a(".navbar-fixed").sticky()), ("vertical-menu" !== t &&
        "vertical-overlay-menu" !== t) ||
        (
    ...
    transit: function(e, n) {
      var t = this;
      i.addClass("changing-menu"), e.call(t), i.hasClass("vertical-layout") &&
      ...
      this.transit(
        function() {
          i
            ...
            .addClass("menu-open"), (this.hidden = !1), (this.expanded = !0);
        },
        function() {
      ...
      this.transit(
        function() {
          i
            ...
            .addClass("menu-hide"), (this.hidden = !0), (this.expanded = !1);
        },
        function() {
          !a(".main-menu").hasClass("menu-native-scroll") &&
            a(".main-menu").hasClass("menu-fixed") &&
          ...
          this.transit(
            function() {
              i
                ...
                .addClass(
                  "menu-expanded"
                ), (this.collapsed = !1), (this.expanded = !0);
            },
            function() {
              a(".main-menu").hasClass("menu-native-scroll") ||
              "horizontal-menu" == i.data("menu")
                ...
                : a(".main-menu").hasClass("menu-fixed") &&
                  this.manualScroller.enable(), ("vertical-menu" !=
                i.data("menu") &&
                "vertical-menu-modern" != i.data("menu")) ||
                !a(".main-menu").hasClass("menu-fixed") ||
                a(".main-menu-content").css(
          ...
          this.transit(
            function() {
              i
                ...
                .addClass(
                  "menu-collapsed"
                ), (this.collapsed = !0), (this.expanded = !1);
            },
            function() {
              "horizontal-menu" == i.data("menu") &&
    ...
    toOverlayMenu: function(e) {
      var n = i.data("menu");
      "sm" == e || "xs" == e
        ? i.hasClass(n) && i.removeClass(n).addClass("vertical-overlay-menu")
        : i.hasClass("vertical-overlay-menu") &&
          i.removeClass("vertical-overlay-menu").addClass(n);
    },
    changeMenu: function(e) {
      a('div[data-menu="menu-wrapper"]').html(""), a(
        ...
        ? (
            ...
            a("ul.dropdown-menu [data-toggle=dropdown]").on("click", function(
              ...
              e.preventDefault(), e.stopPropagation(), a(this)
                .parent()
                .siblings()
                .removeClass("open"), a(this).parent().toggleClass("open");
            })
          )
        : (
            i
    ...
    toggle: function() {
      ...
      switch (e.name) {
        ...
        case "md":
          !0 === n
            ? "vertical-overlay-menu" == t ? this.hide() : this.collapse()
            : "vertical-overlay-menu" == t ? this.open() : this.expand();
          break;
        case "sm":
        case "xs":
    ...
    reset: function() {
      (this.expanded = !1), (this.collapsed = !1), (this.hidden = !1), i.removeClass(
      ...
      a(".navigation-main")
        .on("mouseenter.app.menu", "li", function() {
          ...
          if (
            ...
            a(".main-menu-content").children("span.menu-title").remove(), a(
              ".main-menu-content"
            )
              .children("a.menu-title")
              .remove(), a(".main-menu-content")
              .children("ul.menu-content")
              .remove();
            var t,
              s,
              o = n.find("span.menu-title").clone();
            n.hasClass("has-sub") ||
              (
                (t = n.find("span.menu-title").text()),
        ...
        .on("open.app.menu", "li", function(n) {
          ...
          i
            ...
            .trigger(
              "close.app.menu"
            ), i.siblings(".open").trigger("close.app.menu"), n.stopPropagation();
        })
        ...
        if (i.is(".disabled")) n.preventDefault();
          ...
          if (i.is(".open")) i.removeClass("open"), e.collapse(i);
            ...
            i
              .siblings(".open")
              .find("li.open")
              .trigger("close.app.menu"), i
              .siblings(".open")
              .trigger("close.app.menu"), n.stopPropagation();
          }
        else
          i.is(".active") ||
            (
              i.siblings(".active").trigger("deactive.app.menu"),
              i.trigger("active.app.menu")
            );
        n.stopPropagation();
      });
    },
    adjustSubmenu: function(e) {
      var n,
        ...
        m = d.clone(!0);
      a(".main-menu-header").height(), (n = e.position().top), (s =
        t.height() -
        a(".header-navbar").height()), (l = 0), d.height(), parseInt(
        e.css("border-top"),
        10
      ) > 0 && (l = parseInt(e.css("border-top"), 10)), (o =
        s - n - e.height() - 30), (r = a(".main-menu").hasClass("menu-dark")
        ? "light"
        : "dark"), (i = n + e.height() + l), m
        .addClass("menu-popout")
        .appendTo(".main-menu-content")
        .css({ top: i, position: "fixed", "max-height": o }), a(
        ".main-menu-content > ul.menu-content"
      ).perfectScrollbar({ theme: r });
    },
    collapse: function(e, n) {
      e.children("ul").show().slideUp(a.app.nav.config.speed, function() {
        a(this).css(
          "display",
          ""
        ), a(this).find("> li").removeClass("is-shown"), n && n(), a.app.nav.container.trigger("collapsed.app.menu");
      });
    },
    expand: function(e, n) {
      var i = e.children("ul"),
      ...
      i.hide().slideDown(a.app.nav.config.speed, function() {
        a(this).css(
          "display",
          ""
        ), n && n(), a.app.nav.container.trigger("expanded.app.menu");
      }), setTimeout(function() {
