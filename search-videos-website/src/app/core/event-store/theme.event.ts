...
export class ThemeService {
  ...
  constructor() {
    ...
    if (!this.currentTheme) {
      this.currentTheme = new ThemeSetting();
      this.currentTheme.color = 'bg-primary';
      this.currentTheme.theme = 'navbar-dark';
      this.currentTheme.menuTheme = 'menu-light';
      SecurityHelper.createStore(this.storeKey, this.currentTheme);
    }
    this.sourceChangeHeaderTheme = new BehaviorSubject<ThemeSetting>(this.currentTheme);
